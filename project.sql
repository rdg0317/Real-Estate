...
insert into officelogin values('@ramadg','123456');
DROP TABLE office;
INSERT INTO Admin (username,password) values('@ramadg','123456'),('@prashant_jha','2101150'),('@ryuk','2101159'),('@nikhil','2101132'),('@neeraj','2101130');
...
ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'AVsam4ev@';
FLUSH PRIVILEGES;
...
SELECT * FROM properties WHERE street= 'MG Road' AND number_of_bedroom>=2 AND price <35000 and status='rent';
  ...
  SELECT ag.fname, ag.lname,ag.NOP_sale FROM agent ag INNER JOIN transaction tr ON ag.agent_id = tr.agent_id INNER JOIN properties pr ON tr.pid = pr.pid WHERE YEAR(tr.transaction_date) = 2023 GROUP BY ag.agent_id ORDER BY SUM(tr.transaction_amount) DESC LIMIT 1;
...
SELECT * FROM properties ORDER BY price DESC LIMIT 1;


insert into transaction values('CBS1234',58,4,13,'2023-04-17',1100,55,6);
